...
from dnn.models import ResNet
from dnn.az_dataset import load_mnist_dataset, load_az_dataset
...
#                  input_shape=(32, 32, 1)  # , classes=len(le.classes_)
#                  )
...
for i in np.random.choice(np.arange(0, len(testY)), size=(49,)):
    ...
    # label the color is green (correct)
